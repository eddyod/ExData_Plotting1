...
plot(hpc_min$Date_Time, hpc_min$Voltage, type="l", ylab="Voltage", xlab="datetime")
...
plot(hpc_min$Date_Time, hpc_min$Global_reactive_power, type="l", ylab="Global_reactive_power", xlab="datetime")
dev.off()
